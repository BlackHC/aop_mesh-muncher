...
namespace generic {
	...
	namespace detail {
		...
		template <class SortIter, class PermuteIter> 
		struct iterator_trait< sort_permute_iter<SortIter, PermuteIter> > {
			typedef SortIter SortIter;
			typedef PermuteIter PermuteIter;
		};
	}

	template <typename T> 
	sort_permute_iter_compare< typename detail::iterator_trait<T>::SortIter, typename detail::iterator_trait<T>::PermuteIter>
		make_sort_permute_iter_compare() 
	{
		return sort_permute_iter_compare< typename detail::iterator_trait<T>::SortIter, typename detail::iterator_trait<T>::PermuteIter>();
	}

	template <typename T, typename Pred> 
	sort_permute_iter_compare_pred< Pred, typename detail::iterator_trait<T>::SortIter, typename detail::iterator_trait<T>::PermuteIter>
		make_sort_permute_iter_compare_pred( Pred pred) 
	{
		return sort_permute_iter_compare_pred< Pred, typename detail::iterator_trait<T>::SortIter, typename detail::iterator_trait<T>::PermuteIter>( pred );
	}
}
